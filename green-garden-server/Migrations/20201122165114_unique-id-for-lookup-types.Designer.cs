...
namespace green_garden_server.Migrations
{
    ...
    [Migration("20201122165114_unique-id-for-lookup-types")]
    partial class uniqueidforlookuptypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("green_garden_server.Models.LookupType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "The type of device we are monitoring and controlling",
                            Name = "Device Types",
                            UniqueId = "devicetypes",
                            Updated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("green_garden_server.Models.Device", b =>
                {
                    b.HasOne("green_garden_server.Models.Lookup", "DeviceType")
                        .WithMany()
